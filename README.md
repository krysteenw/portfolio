...
- **[CSOC](https://github.com/krysteenw/Website-CSOC)** — Corporate Security Operations Center web app (React, Node.js, MongoDB) — [live](https://csoc.christinegitumbi.com) · sanitized demo source (fictional company/buildings)
